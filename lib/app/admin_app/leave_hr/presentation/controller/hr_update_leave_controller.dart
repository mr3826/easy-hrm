...
class HrUpdateLeaveController extends GetxController with StateMixin {
  ...
  bool get isButtonEnabledForUpdateLeave {
    return isSelectLeaveType.isNotEmpty || noteValue.isNotEmpty || Get
        .find<FileUploadController>()
        .storageForUpload
        .filePath
        .isNotEmpty || isSelectDate.isNotEmpty;
  }
  ...
  void updateLeave({
    ...
    final response = await NetworkClient().graphRequest(
        queryString: cancelLeaveQuery, variables: {
      "inputData": {
        "leave_id": leaveId,
  ...
  _getFileInfo({required String key,
