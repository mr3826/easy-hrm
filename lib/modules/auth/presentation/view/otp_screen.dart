...
class _OTPScreenState extends State<OTPScreen> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Center(
                  child: Text(
                AppString.text_a_5_digit_has_been_etc.tr,
                style: style,
              )),
              ...
              OtpTextField(
                ...
                fieldWidth: AppLayout.getWidth(50),
  ...
  _resendCodeBtnLayout() {
    return AppButton(
      ...
      onPressed: () async {
        Get.toNamed(Routes.RESET_PASSWORD, arguments: [OTPCode]);
      },
